 ...
 * Created by rajk
 */
public class SalutationSpinnerAdapter extends BaseAdapter {
    private ArrayList<SalutationsData> mItems = new ArrayList<>();
    private Context context;

    public SalutationSpinnerAdapter(Context context){
    ...
    public void addItem(SalutationsData yourObject) {
        mItems.add(yourObject);
    }

    public void addItems(ArrayList<SalutationsData> yourObjectList) {
