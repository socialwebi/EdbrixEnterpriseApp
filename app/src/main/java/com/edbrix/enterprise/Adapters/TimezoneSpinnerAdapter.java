...
public class TimezoneSpinnerAdapter extends BaseAdapter {
    private ArrayList<TimezonesData> mItems = new ArrayList<>();
    ...
    public void addItem(TimezonesData yourObject) {
        mItems.add(yourObject);
    }

    public void addItems(ArrayList<TimezonesData> yourObjectList) {
...
//        return position >= 0 && position < mItems.size() ? mItems.get(position).getTitle(): "";
        return mItems.get(position).getTimezone();
    }
