...
public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.VideoViewHolder> {
    ...
    public VideoListAdapter(Context adContext, List<FileData> filesList, OnButtonActionListener onButtonActionListener) {
    ...
    @Override
    public void onBindViewHolder(final VideoListAdapter.VideoViewHolder holder, final int position) {
